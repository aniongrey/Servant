 ...
 * left in its own look and feel. What Servant has to contribute is the backend
...
void (async () => {
  await ensureApiBase();
  (globalThis as { __SERVANT_API_ORIGIN__?: string }).__SERVANT_API_ORIGIN__ = getApiBaseUrl();
